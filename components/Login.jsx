...
function Login() {
  const [loginType, setLoginType] = useState("form"); // "form" or "wallet"
  ...
  useEffect(() => {
    // Don't auto-connect wallet - let user choose when to connect
  ...
  const handleSubmit = async (e) => {
    ...
    if (loginType === "wallet") {
      ...
      try {
        setError("");
        console.log("🔐 Login: Attempting wallet login...");

        // Create a message for the user to sign
        const message = `Login to Xinetee Dashboard\nTimestamp: ${Date.now()}\nWallet: ${walletAddress}`;
        ...
        console.log("🔐 Login: Got signature from wallet:", signature);

        // Use mock API for wallet login
        const data = await mockApi.loginWithWallet({
          walletAddress: walletAddress,
          signature: signature,
          message: message,
        });

        console.log("✅ Login: Wallet login successful, data:", data);
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Sign in to your Xinetee account
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {loginType === "wallet" ? (
                ...
                <div className="space-y-4">
                  <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl">
                    ...
                    <p className="text-sm text-orange-600 dark:text-orange-400">
                      Connect your MetaMask wallet for instant access
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  {/* Optional Wallet Connection for Form Login */}
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="text-sm text-blue-700 dark:text-blue-300">
                        <p className="font-medium">Optional: Connect Wallet</p>
                        <p className="mt-1">
                          Connect your MetaMask wallet for enhanced features and
                    ...
                    {!isWalletConnected ? (
                      <button
                        ...
                        onClick={connectWallet}
                        disabled={isConnecting}
                        className="mt-3 w-full flex items-center justify-center px-4 py-2 border border-blue-300 dark:border-blue-600 text-sm font-medium rounded-lg text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 hover:bg-blue-200 dark:hover:bg-blue-900/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                      >
                        {isConnecting ? (
                          <>
                            <svg
                      ...
                      <div className="mt-3 p-3 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            type="button"
                            onClick={disconnectWallet}
                            className="text-xs text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-200 font-medium px-2 py-1 rounded hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors duration-200"
                          >
                            Disconnect
                          </button>
                        </div>
              ...
              {loginType === "wallet" ? (
                ...
                // Always show submit button for form login
                <button
                  type="submit"
